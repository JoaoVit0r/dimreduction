...
public class MathRoutines {
    ...
    /**
     * Transposes a 2D floating-point matrix.
     * 
     * <p>
     * This method creates a new matrix where rows of the input matrix become columns,
     * and columns become rows. Transposition is a common operation in data processing
     * to transform the structure of a matrix for different analysis requirements.
     * </p>
     * 
     * <p>
     * In the context of gene expression data, transposition is often used to switch
     * between different representations of the data:
     * <ul>
     *   <li>Genes as rows, samples as columns (common for gene-focused analysis)</li>
     *   <li>Samples as rows, genes as columns (common for sample-focused analysis)</li>
     * </ul>
     * </p>
     *
