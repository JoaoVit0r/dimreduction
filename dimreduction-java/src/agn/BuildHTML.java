...
public class BuildHTML {
    ...
    public static synchronized void BuildIndexPage(AGN agn,
        ...
        GraphDR frame = AGNRoutines.ViewAGNMA(agn, targetindexes);
        ...
        BufferedImage img = frame.graph.getImage(frame.graph.getBackground(), 0);
        ImageIO.write(img, "png", out);
        out.flush();
        out.close();
        String imagemap = getImageMap(agn, frame.graph, filename+".png");
        frame.dispose();
