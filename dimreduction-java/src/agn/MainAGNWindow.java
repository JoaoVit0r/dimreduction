...
public class MainAGNWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTF_Quantization.setToolTipText("n�mero m�ximo de vezes que um determinado gene pode ser preditor de outros genes.");
        ...
        jTF_InputRules.setText("D:\\doutorado\\dimreduction\\dist\\resultadosMA-normalization-considering-controls\\razoes-shoot\\complete-agn-dados-razoes-frio-normal-shoot.agnnew");
        ...
        jLabel27.setToolTipText("n�mero m�ximo de vezes que um determinado gene pode ser preditor de outros genes.");
        jPanel16.add(jLabel27);
        jLabel27.setBounds(330, 10, 120, 30);

        jCB_NetType.setMaximumRowCount(4);
        jCB_NetType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ER-Erd�s-R�nyi (random)", "BA-Barab�si-Albert (scale-free)", "GG-Geographical" }));
        jPanel16.add(jCB_NetType);
        jCB_NetType.setBounds(450, 10, 230, 30);

        jLabel34.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel34.setText("Time Observations: ");
        jLabel34.setToolTipText("n�mero m�ximo de vezes que um determinado gene pode ser preditor de outros genes.");
        jPanel16.add(jLabel34);
        jLabel34.setBounds(170, 50, 120, 30);

        jTF_NrObs.setText("10");
        jTF_NrObs.setToolTipText("n�mero m�ximo de vezes que um determinado gene pode ser preditor de outros genes.");
        ...
        jLabel35.setToolTipText("n�mero m�ximo de vezes que um determinado gene pode ser preditor de outros genes.");
        jPanel16.add(jLabel35);
        jLabel35.setBounds(330, 50, 120, 30);

        jTF_NrInitializations.setText("0");
        jTF_NrInitializations.setToolTipText("n�mero m�ximo de vezes que um determinado gene pode ser preditor de outros genes.");
        jPanel16.add(jTF_NrInitializations);
        jTF_NrInitializations.setBounds(450, 50, 40, 30);

        jLabel28.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel28.setText("Rules Type: ");
        jLabel28.setToolTipText("n�mero m�ximo de vezes que um determinado gene pode ser preditor de outros genes.");
        ...
        jButton31.setBounds(250, 20, 237, 60);
        ...
        if (rulestype == 0) {//Boolean
            if (quantization != 2) {
                JOptionPane.showMessageDialog(this, "The rules type is " +
                        "incompatible with quantization.", "Parameters are " +
                        "Incompatible", JOptionPane.ERROR_MESSAGE);
                return;
            }
        }
        agn = Topologies.CreateNetwork(nr_nodes, nr_obs, maxconcat,
                avg_edges, quantization, networkmodel, allbf);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        if (agn != null) {
            AGNRoutines.ViewAGNMA(agn, null);
        } else {
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        ...
        Preprocessing.quantizecolumns(Md, qv, true, has_labels);
